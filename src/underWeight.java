...
public class underWeight extends JFrame implements ActionListener, MouseListener
{
	...
	public underWeight(double bmi) 
	{
       ...
       // ImageIcon i = new ImageIcon("Image/overweight.png");
        ImageIcon i = new ImageIcon(new ImageIcon("Image/underweight.gif").getImage().getScaledInstance(250, 220, Image.SCALE_DEFAULT));
        ...
        label1=new JLabel();
        under.add(label1);
        label1.setText("UnderWeight | "+Double.toString(bmi));
